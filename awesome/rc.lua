...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.layouttimer = gears.timer({timeout = 2})
    ...
    s.layouttimer:connect_signal("timeout", function () s.layoutpopup.visible = false
                                                        screen.layouttimer:stop() end)
    s.layoutpopup:connect_signal("mouse::enter", function () s.layouttimer:stop() end)
    s.layoutpopup:connect_signal("mouse::leave", function () s.layouttimer:start() end)
