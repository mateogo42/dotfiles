...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,    }, "d", function () awful.spawn("rofi -modi run -show drun -show-icons -terminal alacritty") end,
    ...
    awful.key({ modkey   }, "space", 
        function () 
            ...
            if screen.layoutpopup.visible == false then
                screen.layoutpopup.visible = true
                screen.layouttimer:start()
            else
                screen.layouttimer:again()
            end
